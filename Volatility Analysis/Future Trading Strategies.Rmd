---
title: "Future Trading Strategies"
...
corvixret <- dailyReturn(corvix,type="arithmetic")
corspxtrret <- dailyReturn(corspxtr,type="arithmetic")
...
hvol <- volatility(fspxohlc,calc="close",n=21,N=252)
vrp <- vix-hvol
...
lines(vix,col="blue")
legend("topright",col=c("black","blue"),lty=1,legend=c("hvol","vix"))

# 4.3. Volatility Risk Premium Chart
plot(vrpsma21,main="Volatility Risk Premium")
abline(h=0,col="blue")
legend("bottomright",col="black",lty=1,legend="vrpsma21")
...
abline(h=mean(spxvolmdiff)-3*sd(spxvolmdiff),col="green")
legend("topleft",col=c("black","orange","green"),lty=1,legend=c("spxvolmdiff","mean","+/- 3 stdev"),cex=0.75)

# 7.3. Historical Stocks Volatility Index Monthly Differences Normality
qqnorm(spxvolmdiff);qqline(spxvolmdiff,col="red")
