...
library("fGarch")
 ...
 # Load only after estimating historical volatilities
...
# Quandl.api_key("YOUR API KEY") # Use to register Quandl API Key

# 2. Data Downloading
htickers <- "CBOE/VIX/4"
htickers2 <- "^GSPC"
hdata <- Quandl(htickers,type="xts",start_date="2007-01-01",end_date="2017-01-01")
getSymbols(htickers2,src='yahoo',from="2007-01-01",to="2017-01-01")
...
hvolp <- volatility(hspxohlc,calc="parkinson",n=21,N=252)
...
legend("topright",col=c("black","blue"),lty=1,legend=c("cc","p"))

# 3.3. Garman-Klass Estimation
hvolgk <- volatility(hspxohlc,calc="garman.klass",n=21,N=252)
...
legend("topright",col=c("black","red"),lty=1,legend=c("cc","gk"))

# 3.4. Rogers-Satchell Estimation
hvolrs <- volatility(hspxohlc,calc="rogers.satchell",n=21,N=252)
...
legend("topright",col=c("black","orange"),lty=1,legend=c("cc","rs"))

# 3.5. Garman-Klass-Yang-Zhang Estimation
hvolgkyz <- volatility(hspxohlc,calc="gk.yz",n=21,N=252)
...
legend("topright",col=c("black","green"),lty=1,legend=c("cc","gkyz"))

# 3.6. Yang-Zhang Estimation
hvolyz <- volatility(hspxohlc,calc="yang.zhang",n=21,N=252)
...
legend("topright",col=c("black","cyan"),lty=1,legend=c("cc","yz"))
...
legend("topright",col=c("black","blue"),lty=1,legend=c("cc","rwfcst"))
...
legend("topright",col=c("black","red"),lty=1,legend=c("cc","meanfcst"))
...
legend("topright",col=c("black","orange"),lty=1,legend=c("cc","smafcst"))
...
legend("topright",col=c("black","green"),lty=1,legend=c("cc","emafcst"))
...
legend("topright",col=c("black","cyan"),lty=1,legend=c("cc","arimafcst"))
...
hgarchmodel <- garchFit(formula = ~ garch(1, 1),data=harimafcst[42:2518])
...
legend("topright",col=c("black","pink"),lty=1,legend=c("cc","garchfcst"))

# 4.7. Historical Volatility Forecasting Accuracy

# 4.7.1. Create Undated Volatility Forecast Time Series 
hfcst <- cbind(uhvolcc,hrwfcst,hmeanfcst,hsmafcst,hemafcst,harimafcst,hgarchfcst)
colnames(hfcst) <- cbind("hvolcc","hrwfcst","hmeanfcst","hsmafcst","hemafcst","harimafcst","hgarchfcst")
...
lines(ivol,col="blue")
legend("topright",col=c("black","blue"),lty=1,legend=c("cc","pvix"))
