...
odata <- Quandl(otickers,type="xts",end_date="2017-01-01")
getSymbols(otickers2,src='yahoo',to="2017-01-01")
odata <- cbind(GSPC[,6],SP500TR[,6],odata[,1:3])
getSymbols(otickers3,src='yahoo',to="2017-01-01")
...
abline(h=mean(spxmret)-3*sd(spxmret),col="green")
legend("topleft",col=c("black","orange","green"),lty=1,legend=c("spxmret","mean","+/- 3 stdev"),cex=0.60)

# 3.2. Historical Stocks Index Monthly Returns Normality
qqnorm(spxmret);qqline(spxmret,col="red")
